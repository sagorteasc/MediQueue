...
const TutorDetailsCard = ({ tutorDetails }) => {
    ...
    return (
        ...
        >
            <Card className="w-11/12 mx-auto shadow-lg p-6 md:p-8 hover:border hover:border-purple-500">

                <h1 className="font-bold text-4xl text-center text-(--primary-text) mb-4">Learn More About <strong className="text-cyan-500">{name}</strong></h1>
                ...
                <div className="md:grid md:grid-cols-3 gap-6">
                    <div className="col-span-1 flex flex-col items-center text-center border-b md:border-b-0 md:border-r border-gray-200 pb-5 md:pb-0 md:pr-5">
                        ...
                        <div className="mt-5 space-y-4">
                            <h4 className="font-bold text-xl text-(--primary-text)">{name}</h4>
                    ...
                    <div className="flex flex-col col-span-2 justify-between">
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className="bg-gray-50 dark:bg-[#18181b] border border-gray-200 rounded-2xl p-5">
                                <p className='text-sm text-gray-500 mb-1'>Subject</p>
                                <h3 className="font-medium text-(--primary-text)">{subject}</h3>
                            </div>
                            <div className="bg-gray-50 dark:bg-[#18181b] border border-gray-200 rounded-2xl p-5">
                                <p className='text-sm text-gray-500 mb-1'>Teaching Mode</p>
                                <h3 className="font-medium text-(--primary-text)">{teachingMode}</h3>
                            </div>
                            <div className="bg-gray-50 dark:bg-[#18181b] border border-gray-200 rounded-2xl p-5">
                                <p className='text-sm text-gray-500 mb-1'>Experience</p>
                                <h3 className="font-medium text-(--primary-text)">{experience}</h3>
                            </div>
                            <div className="bg-gray-50 dark:bg-[#18181b] border border-gray-200 rounded-2xl p-5">
                                <p className='text-sm text-gray-500 mb-1'>Institution</p>
                                <h3 className="font-medium text-(--primary-text)">{institution}</h3>
                            </div>
                            <div className="bg-gray-50 dark:bg-[#18181b] border border-gray-200 rounded-2xl p-5">
                                <p className='text-sm text-gray-500 mb-1'>Hourly Fee</p>
                                <h3 className="font-medium text-(--primary-text)">{hourlyFee} TK.</h3>
                            </div>
                            <div className="bg-gray-50 dark:bg-[#18181b] border border-gray-200 rounded-2xl p-5">
                                <p className='text-sm text-gray-500 mb-1'>Total Slot</p>
                                <h3 className="font-medium text-(--primary-text)">{slot}</h3>
                            </div>
                            <div className="bg-gray-50 dark:bg-[#18181b] border border-gray-200 rounded-2xl p-5">
                                <p className='text-sm text-gray-500 mb-1'>Session Start</p>
                                <h3 className="font-medium text-(--primary-text)">{sessionStartDate}</h3>
                            </div>
